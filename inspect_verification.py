...
import pandas as pd
from app.three_step_verification import parse_step1_order_excel, parse_step2_sales_order_pdf, compare_step2
import tempfile
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    pd.DataFrame([{'product': 'Sheet Sets', 'quantity': 1728, 'rate': 1049, 'gst': 5}]).to_excel(filled_file, index=False)
