...
def test_morning_suggestion_list_prioritizes_longest_idle_entities(tmp_path: Path) -> None:
    ...
    db.add_distributor_visit_log(distributor_id, "2026-06-20", "09:00", {"current_stock_audit": "Good"})
    db.add_retailer_visit_log(retailer_id, distributor_id, "2026-06-18", "11:00", {"secondary_sales_volume": "20"})
    ...
    assert suggestions[0]["entity_id"] == retailer_id if suggestions[0]["entity_type"] == "retailer" else distributor_id
...
def test_weekly_pjp_plan_and_dsr_date_range_filter(tmp_path: Path) -> None:
    ...
    db.add_distributor_visit_log(distributor_id, "2026-06-22", "08:30", {"current_stock_audit": "Good"})
    db.add_retailer_visit_log(retailer_id, distributor_id, "2026-06-22", "10:00", {"secondary_sales_volume": "15"})
